            ...
            try
            {
                ...
                if (var1 != null)
                {
                    synchronized (NetworkListenThread.func_35504_b(this.netWorkListener))
                    {
                        ...
                        if (NetworkListenThread.func_35504_b(this.netWorkListener).containsKey(var3) && !"127.0.0.1".equals(var3.getHostAddress()) && System.currentTimeMillis() - ((Long)NetworkListenThread.func_35504_b(this.netWorkListener).get(var3)).longValue() < 4000L)
                        {
