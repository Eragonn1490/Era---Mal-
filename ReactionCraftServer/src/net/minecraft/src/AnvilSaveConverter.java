...
public class AnvilSaveConverter extends SaveFormatOld
{
    ...
    public boolean isOldMapFormat(String par1Str)
    {
        ...
        return var2 != null && var2.getSaveVersion() != this.func_48495_a();
    }
    ...
    public boolean convertMapFormat(String par1Str, IProgressUpdate par2IProgressUpdate)
    {
        ...
        this.func_48499_a(var6, var3);

        if (var7.exists())
        {
            this.func_48499_a(var7, var4);
        }

        if (var8.exists())
        {
            this.func_48499_a(var8, var5);
        }
        ...
        this.func_48497_a(new File(var6, "region"), var3, (WorldChunkManager)var11, 0, var9, par2IProgressUpdate);
        this.func_48497_a(new File(var7, "region"), var4, new WorldChunkManagerHell(BiomeGenBase.hell, 1.0F, 0.0F), var3.size(), var9, par2IProgressUpdate);
        this.func_48497_a(new File(var8, "region"), var5, new WorldChunkManagerHell(BiomeGenBase.sky, 0.5F, 0.0F), var3.size() + var4.size(), var9, par2IProgressUpdate);
    ...
    private void func_48497_a(File par1File, ArrayList par2ArrayList, WorldChunkManager par3WorldChunkManager, int par4, int par5, IProgressUpdate par6IProgressUpdate)
    {
        ...
        while (var7.hasNext())
        {
            ...
            this.func_48496_a(par1File, var8, par3WorldChunkManager, par4, par5, par6IProgressUpdate);
            ++par4;
