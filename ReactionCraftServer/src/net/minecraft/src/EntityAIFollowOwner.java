...
public class EntityAIFollowOwner extends EntityAIBase
{
    ...
    public void startExecuting()
    {
        ...
        this.field_48253_i = this.thePet.getNavigator().getAvoidsWater();
    ...
    public void resetTask()
    {
        ...
        this.thePet.getNavigator().setAvoidsWater(this.field_48253_i);
    }
    ...
    public void updateTask()
    {
        ...
        if (!this.thePet.isSitting())
        {
            if (--this.field_48252_h <= 0)
            {
                ...
                if (!this.petPathfinder.tryMoveToEntityLiving(this.theOwner, this.field_48245_f))
                {
