...
public class EntityAIMoveThroughVillage extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            {
                this.doorInfo = this.func_48276_a(var1);
                ...
                else
                {
                    ...
                    this.field_48282_c = this.theEntity.getNavigator().getPathToXYZ((double)this.doorInfo.posX, (double)this.doorInfo.posY, (double)this.doorInfo.posZ);
                    ...
                    {
                        Vec3D var3 = RandomPositionGenerator.func_48395_a(this.theEntity, 10, 7, Vec3D.createVector((double)this.doorInfo.posX, (double)this.doorInfo.posY, (double)this.doorInfo.posZ));
                        ...
                        {
                            this.theEntity.getNavigator().setBreakDoors(false);
                            this.field_48282_c = this.theEntity.getNavigator().getPathToXYZ(var3.xCoord, var3.yCoord, var3.zCoord);
                            this.theEntity.getNavigator().setBreakDoors(var2);
