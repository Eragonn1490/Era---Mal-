...
public class EntityAIMoveIndoors extends EntityAIBase
{
    ...
    public void startExecuting()
    {
        ...
        {
            Vec3D var1 = RandomPositionGenerator.func_48395_a(this.entityObj, 14, 3, Vec3D.createVector((double)this.doorInfo.getInsidePosX() + 0.5D, (double)this.doorInfo.getInsidePosY(), (double)this.doorInfo.getInsidePosZ() + 0.5D));
