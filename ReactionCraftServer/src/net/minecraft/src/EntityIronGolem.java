...
public class EntityIronGolem extends EntityGolem
{
    ...
    {
        return this.func_48379_n_() && EntityPlayer.class.isAssignableFrom(par1Class) ? false : super.func_48336_a(par1Class);
    }
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setBoolean("PlayerCreated", this.func_48379_n_());
    }
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.func_48381_b(par1NBTTagCompound.getBoolean("PlayerCreated"));
    }
