...
public class ChunkProviderHell implements IChunkProvider
{
    ...
    public void generateNetherTerrain(int par1, int par2, byte[] par3ArrayOfByte)
    {
        ...
        byte var7 = 17;
        int var8 = var4 + 1;
        this.field_4234_o = this.func_4060_a(this.field_4234_o, par1 * var4, 0, par2 * var4, var6, var7, var8);
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        this.func_4061_b(par1, par2, var3);
    ...
    {
        if (par1EnumCreatureType == EnumCreatureType.monster && this.genNetherBridge.func_40204_a(par2, par3, par4))
        {
