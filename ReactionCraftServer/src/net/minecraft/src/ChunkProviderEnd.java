...
public class ChunkProviderEnd implements IChunkProvider
{
    ...
    public void func_40184_a(int par1, int par2, byte[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
    {
        ...
        byte var7 = 33;
        int var8 = var5 + 1;
        this.densities = this.func_40186_a(this.densities, par1 * var5, 0, par2 * var5, var6, var7, var8);
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        this.func_40184_a(par1, par2, var3, this.biomesForGeneration);
        this.func_40185_b(par1, par2, var3, this.biomesForGeneration);
