...
public class EntityAITempt extends EntityAIBase
{
    ...
    public void startExecuting()
    {
        ...
        this.field_48270_m = this.temptedEntity.getNavigator().getAvoidsWater();
    ...
    public void resetTask()
    {
        ...
        this.temptedEntity.getNavigator().setAvoidsWater(this.field_48270_m);
    }
    ...
    public void updateTask()
    {
        ...
        {
            this.temptedEntity.getNavigator().tryMoveToEntityLiving(this.temptingPlayer, this.field_48266_b);
        }
    }
