...
public class EntityAIAttackOnCollide extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            this.field_48154_g = this.attacker.getNavigator().getPathToEntityLiving(this.entityTarget);
    ...
    {
        EntityLiving var1 = this.attacker.getAttackTarget();
        return var1 == null ? false : (!this.entityTarget.isEntityAlive() ? false : (!this.field_48153_f ? !this.attacker.getNavigator().noPath() : this.attacker.isWithinHomeDistance(MathHelper.floor_double(this.entityTarget.posX), MathHelper.floor_double(this.entityTarget.posY), MathHelper.floor_double(this.entityTarget.posZ))));
    }
    ...
    {
        this.attacker.getNavigator().setPath(this.field_48154_g, this.field_48155_e);
    ...
    public void updateTask()
    {
        ...
        if ((this.field_48153_f || this.attacker.getEntitySenses().canSee(this.entityTarget)) && --this.field_48158_i <= 0)
        {
            this.field_48158_i = 4 + this.attacker.getRNG().nextInt(7);
            this.attacker.getNavigator().tryMoveToEntityLiving(this.entityTarget, this.field_48155_e);
        }
