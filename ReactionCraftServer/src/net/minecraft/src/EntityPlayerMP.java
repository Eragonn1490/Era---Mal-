        ...
        if (par1 && !this.loadedChunks.isEmpty())
        {
            ...
            if (var10 != null)
            {
                ...
                if (var14)
                {
                    ...
                    if (var15.blockExists(var10.chunkXPos << 4, 0, var10.chunkZPosition << 4))
                    {
                        Chunk var16 = var15.getChunkFromChunkCoords(var10.chunkXPos, var10.chunkZPosition);

                        if (var16.isTerrainPopulated)
                        {
                            this.loadedChunks.remove(var10);
                            this.playerNetServerHandler.sendPacket(new Packet51MapChunk(var15.getChunkFromChunkCoords(var10.chunkXPos, var10.chunkZPosition), true, 0));
                            List var8 = var15.getTileEntityList(var10.chunkXPos * 16, 0, var10.chunkZPosition * 16, var10.chunkXPos * 16 + 16, 256, var10.chunkZPosition * 16 + 16);
