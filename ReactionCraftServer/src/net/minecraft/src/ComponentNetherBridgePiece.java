...
abstract class ComponentNetherBridgePiece extends StructureComponent
{
    ...
    private int getTotalWeight(List par1List)
    {
        ...
        for (Iterator var4 = par1List.iterator(); var4.hasNext(); var3 += var5.field_40653_b)
        {
            var5 = (StructureNetherBridgePieceWeight)var4.next();

            if (var5.field_40651_d > 0 && var5.field_40654_c < var5.field_40651_d)
            {
                var2 = true;
            }
        }
    ...
    private StructureComponent getNextComponent(ComponentNetherBridgeStartPiece par1ComponentNetherBridgeStartPiece, List par2List, Random par3Random, int par4, int par5, int par6, int par7, int par8, boolean par9)
    {
        ...
        {
            List var12 = par1ComponentNetherBridgeStartPiece.field_40294_b;

            if (par9)
            {
                var12 = par1ComponentNetherBridgeStartPiece.field_40295_c;
            }
            ...
            {
                par2List.add(var11);
                par1ComponentNetherBridgeStartPiece.field_40293_d.add(var11);
            }
        ...
        {
            ComponentNetherBridgeEnd var10 = ComponentNetherBridgeEnd.func_40301_a(par2List, par3Random, par4, par5, par6, par7, par8);
            return var10;
        }
    }
