...
public class AncientPlant extends BlockFlower implements ITextureProvider
{
    public AncientPlant(int par1, int par2)
    {
        super(par1, par2);
    ...
    public ArrayList<ItemStack> getBlockDropped(World world, int x, int y, int z, int metadata, int fortune)
    {
        ...
        if (metadata == 7)
        {
            ret.add(new ItemStack(mod_ReactionCraft.AncientFruit));
        }
        ...
        for (int n = 0; n < 3 + fortune; n++)
        {
            ...
            {
                ret.add(new ItemStack(mod_ReactionCraft.AncientSeeds));
            }
        }
