...
public class RcFenceBlock extends BlockFence implements ITextureProvider
{
    public RcFenceBlock(int i, int j)
    {
        super(i, j, Material.wood);
    }

    public RcFenceBlock(int i, int j, Material material)
    {
        super(i, j, material);
    }
