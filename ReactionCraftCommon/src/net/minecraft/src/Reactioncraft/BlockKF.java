...
public class BlockKF extends BlockFlower implements ITextureProvider
{
    public BlockKF(int par1, int par2)
    {
        super(par1, par2);
    ...
    public ArrayList<ItemStack> getBlockDropped(World world, int x, int y, int z, int metadata, int fortune)
    {
        ...
        if (metadata == 7)
        {
            ret.add(new ItemStack(mod_ReactionCraft.FireBud));
        }
        ...
        for (int n = 0; n < 3 + fortune; n++)
        {
            ...
            {
                ret.add(new ItemStack(mod_ReactionCraft.FireSeed));
            }
        }
    ...
    {
        return par1 == 7 ? mod_ReactionCraft.FireSeed.shiftedIndex : -1;
    }
