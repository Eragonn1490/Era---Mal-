...
public class RcBlockChest extends BlockContainer implements ITextureProvider
{
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        RcTileEntityChest var6 = (RcTileEntityChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        RcTileEntityChest var5 = (RcTileEntityChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        Object var6 = (RcTileEntityChest)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                var6 = new InventoryLargeChest("Large chest", (RcTileEntityChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)var6);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                var6 = new InventoryLargeChest("Large chest", (IInventory)var6, (RcTileEntityChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                var6 = new InventoryLargeChest("Large chest", (RcTileEntityChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)var6);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                var6 = new InventoryLargeChest("Large chest", (IInventory)var6, (RcTileEntityChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
