...
public class ModelVillagerStatue extends ModelBase
{
    private static float par1;
    ...
    public ModelVillagerStatue(float par1, float par2)
    {
        byte var3 = 64;
        byte var4 = 64;
	...
	public void renderModel(float f1) {
		this.field_40340_a.render(f1);
        this.field_40338_b.render(f1);
        this.field_40336_d.render(f1);
        this.field_40337_e.render(f1);
        this.field_40339_c.render(f1);
