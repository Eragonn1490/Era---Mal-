...
public class RcFenceBlock1 extends BlockFence implements ITextureProvider
{
    public RcFenceBlock1(int i, int j)
    {
        super(i, j, Material.wood);
    }

    public RcFenceBlock1(int i, int j, Material material)
    {
        super(i, j, material);
    }
	...
	public String getTextureFile() {
		...
		return "/reactioncraft/extendedcolumn.png";
	}
}
