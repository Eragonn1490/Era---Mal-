...
public class BlockOK extends BlockFlower implements ITextureProvider
{
    public BlockOK(int par1, int par2)
    {
        super(par1, par2);
    ...
    {
        return par1 == 7 ? mod_ReactionCraft.OKSeed.shiftedIndex : -1;
    }
