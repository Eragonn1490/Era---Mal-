...
public class WaterGeneration extends WorldGenerator
{
	private int minableBlockId;
	private int numberOfBlocks;

		public WaterGeneration(int i, int j)
		{
			minableBlockId = i;
			numberOfBlocks = j;
		}
													...
													if (d12 * d12 + d13 * d13 >= 1.0D)
														...
														continue;
															...
															for (int i3 = k1; i3 <= j2; i3++)
															{
																...
																if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && world.getBlockId(k2, l2, i3) == Block.waterStill.blockID && world.getBlockId(k2, l2-1, i3) != Block.waterStill.blockID )
																{
