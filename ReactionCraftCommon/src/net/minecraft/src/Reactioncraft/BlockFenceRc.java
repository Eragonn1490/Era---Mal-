...
public class BlockFenceRc extends BlockFence implements ITextureProvider
{
    public BlockFenceRc(int i, int j)
    {
        super(i, j, Material.wood);
    }

    public BlockFenceRc(int i, int j, Material material)
    {
        super(i, j, material);
    }
